 ...
 * @brief Implementación de la clase GEGraphicsContext.
 */
...
/**
 * @brief Crea un contexto gráfico de Vulkan (instancia, dispositivo físico y lógico).
...
/**
 * @brief Destruye el contexto gráfico.
 */
...
/**
 * @brief Busca el tipo de memoria adecuado para el filtro indicado.
 * @param typeFilter Filtro de tipos de memoria.
...
/**
 * @brief Busca el formato adecuado para el buffer de profundidad.
...
/**
 * @brief Crea la superficie sobre la que mostrar la representación gráfica.
 * @param window Ventana GLFW sobre la que crear la superficie.
 * @sa @ref GLFWwindow
 */
...
/**
 * @brief Selecciona el dispositivo físico sobre el que generar los gráficos.
 */
...
/**
 * @brief Crea el dispositivo lógico sobre el que generar los gráficos y selecciona la familia de colas sobre el dispositivo.
 */
...
/**
 * @brief Muestra las propiedades de la instancia.
 */
...
/**
 * @brief Verifica si un dispositivo físico admite generación de gráficos.
...
/**
 * @brief Muestra los dispositivos físicos disponibles y genera un archivo con las propiedades de cada uno.
 */
...
/**
 * @brief Escribe las características del dispositivo físico.
